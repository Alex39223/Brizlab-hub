...
function NavLink({
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm text-zinc-400
                 hover:text-zinc-100 hover:bg-surface-2 transition-all duration-150 group"
    >
